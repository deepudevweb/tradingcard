    ...
    if (loading) {
        ...
        return (
            <div className="container">
                <div className="card">
                    <div className="top">
                        <img className="image" src={data.picture.large} alt="" />
                        <img className="logo" src={trade} alt="" />
                        <h1 className="heading">Xml<span>trader</span> <br /> </h1>
                        <h4 className="contact">ph : {data.phone}</h4>
                        <div className="name">
                            <h2 >{data.name.title}. <span> {data.name.first} </span>  <span>{data.name.last}</span></h2>
                        </div>
                    </div>
                    <div className="mid">
                ...
                <button className="fetch-btn" onClick={handleButtonClick}>Get random user</button>
            </div>
        );
    }
}
